...
import 'package:telentproapp/bloc/get_all_product_state.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocBuilder<ProductCubit, GetAllProductState>(
                ...
                return Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 20,),
                      Text('${state.loadingText}'.toUpperCase(),style: loadingStyle,)
                    ],
                  ),
                );
              }
                                  ...
                                  showAnimatedDialog(
                                    ...
                                    builder: (BuildContext context) {
                                      return ClassicGeneralDialogWidget(
                                        ...
                                        onPositiveClick: () {
                                          BlocProvider.of<ProductCubit>(context).deleteProduct(product.proId!);
